...
var ScratchMe = function ScratchMe(_ref) {
	...
	var scratchMeInit = function scratchMeInit() {
		...
		foregroundImage.onload = function () {
			drawImageScaled(this,foregroundContext)
		...
		backgroundImage.onload = function () {
			drawImageScaled(this,backgroundContext)
		...
		var renderCanvas = function renderCanvas() {
			if (drawing) {
				...
				if (percent >= completedAt && !isCompleted) {
					clearCanvas(foregroundContext, foregroundCanvas)
					setIsCompleted(true);
					onCompleted();
				}
			}
	...
	return _react2.default.createElement(
		"div",
		{ style: _extends({}, styles.container, { width: width, height: height, left: `calc(50% - ${width/2}px)` }) },
